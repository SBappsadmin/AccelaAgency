		...
		if (capArray[x].getCapType() != "Enforcement/Violations/Environmental/Continuous Enforcement")
		{
			...
			if(invoiceResult.getSuccess())
			{
				...
				for(y in invoiceArray)
				{
					...
					if ((invModel.getBalanceDue() != 0) && (invModel.getAuditStatus() == "A") && (Math.ceil((todayDate-invDate)/(1000*3600*24))> 30))
					{
...
else
{
 ...
 var emailText = "Owner1|Owner2|Mail Address 1|Mail City 1|Mail State 1|Mail Zip 1|Mail Address 2|Mail City 2|Mail State 2|Mail Zip 2|Description|"+
